    ...
    <div class="container form-container">
        ...
        <form action="{{ route('registration.process') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Saisir le nom ici ...">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" name="passwordConfirm" id="passwordConfirm" class="form-control" placeholder="Confirmer le mot de passe ici ...">
            </div>
